...
# Đổi tất cả key trong paths có hậu tố _dir hoặc _path từ đường dẫn tương đối thành tuyệt đối theo ROOT_DIR.
...
# Hàm kiểm tra section, prototype, đặc biệt là danh sách tháng dữ liệu cần xử lý
...
# Load app config từ duy nhất 1 file: config/settings.yml
